...
exports.post = async (req, res, next) => {
  ...
  try {
    ...
    await repository.create({
      ...
      inputHour: req.body.inputHour,
      exitHour: req.body.exitHour,
      latPoint: req.body.latPoint,
      lonPoint: req.body.lonPoint
      //  image: 'https://nodestrleo.blob.core.windows.net/product-images/' + filename
    });
    res.status(201).send({
      message: "Apontamento cadastrado com sucesso!"
    });
  } catch (e) {
    console.log(e);
    res.status(500).send({
